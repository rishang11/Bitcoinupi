...
//       <button className="bg-red-500 text-white p-2 rounded"  >Create Psbt</button>
...
export default function FileUpload() {
  ...
  const createPsbtHandler = async () => {
    try {
      ...
      // Update addedInputs to reflect the inputStates after API call
      setAddedInputs(inputStates);
